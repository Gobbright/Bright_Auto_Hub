...
import '../styles/pages/blog-editorial.css'
      ...
      <header className='relative'>
        <div className='mx-auto w-full max-w-[1240px] px-[18px] pb-8 pt-[clamp(24px,4vw,54px)]'>
          ...
          <div className='grid gap-8 lg:grid-cols-[1fr_460px] lg:items-end'>
            ...
            <div className='rounded-2xl bg-[#e5091a] p-6 text-white shadow-[0_18px_45px_rgba(229,9,26,.22)] lg:mb-2'><small className='text-[9px] font-black tracking-[.14em] text-red-100'>ADVERTISEMENT</small><h2 className='mb-2 mt-2 text-2xl font-bold leading-tight'>Place Your Ad Here</h2><p className='text-xs leading-6 text-red-100'>Promote your vehicle brand, dealership or service offer to active readers.</p><Link className='mt-3 inline-flex w-full justify-center rounded-lg bg-white px-3 py-2.5 text-[10px] font-extrabold text-[#d7081b] transition hover:bg-red-50' to='/contact?subject=Advertisement+enquiry&item=Blog+sidebar+advertisement&source=advertisement'>Advertise with us</Link></div>
          </div>
